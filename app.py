...
def main():
    ...
    <div style='text-align: center; color: gray;'>
        <p>Richard Dean Tanjaya | Github: <a href="https://github.com/RichardDeanTan/indonesian-article-summarization" target="_blank">@RichardDeanTan</a> | Huggingface: <a href="https://huggingface.co/RichTan/indobart-custom" target="_blank">@RichTan</a></p>
    </div>
    """, unsafe_allow_html=True)
